...
public class NPCController_1_15_R1 implements NPCController {
	...
	public void playAction(NPCAction action) {
		...
		case JUMP:
			...
			PacketPlayOutRelEntityMove move = new PacketPlayOutRelEntityMove(entityId, (short) 0, (short) jumpHeight,
					(short) 0, true);
			PacketUtils.sendPacket(move);

			Bukkit.getScheduler().runTaskLater(ActorNPC.getInstance(), () -> {
				PacketPlayOutRelEntityMove moveDown = new PacketPlayOutRelEntityMove(entityId, (short) 0,
						(short) -jumpHeight, (short) 0, true);
	...
	public void setAnimation(byte animation) {
		try {
			PacketPlayOutAnimation playAnimation = new PacketPlayOutAnimation(npc.getBukkitEntity().getHandle(),
					(int) animation);
